...
sortButtons.addEventListener("click", (event) => {
    ...
    } else if (sortType === "sortZA") {
        students.sort((a, b) => (b.first_name + b.last_name).localeCompare(a.first_name + a.last_name));
    } else if (sortType === "sortByMarks") {
        students.sort((a, b) => a.marks - b.marks);
    } else if (sortType === "sortByPassing") {
        students.sort((a, b) => a.passing - b.passing);
    } else if (sortType === "sortByClass") {
        students.sort((a, b) => a.class.localeCompare(b.class));
    } else if (sortType === "sortByGender") {
        const maleStudents = students.filter((student) => student.gender === "Male");
        const femaleStudents = students.filter((student) => student.gender === "Female");
        const genderTables = document.querySelector("#genderTables");
        genderTables.innerHTML = `
        `;
        populateTable(maleStudents);
        populateTable(femaleStudents);
        return;
    }
